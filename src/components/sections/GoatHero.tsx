...
export function GoatHero() {
  return (
    <section className="relative w-full h-screen min-h-[600px] overflow-hidden">
      ...
      >
        <Image
          src="/images/the-goats/hero-goats.jpg"
          alt="Goat Sponsorship — New Mercy Community Church"
          fill
      ...
      <div className="absolute inset-0 flex items-end">
        <div className="max-w-[1400px] mx-auto px-6 pb-24 w-full">
          ...
          <h1 className="font-heading text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white leading-[0.9] mb-6">
            Goat Sponsorship
          </h1>
          <div className="w-12 h-px bg-accent-gold/60 mb-5" />
          <p className="text-white/70 text-base tracking-wide max-w-md">
            Partner with a family by sponsoring a pair of goats.
          </p>
        </div>
      </div>
